...
(function(){
      ...
      return '<div class="dm-modal"><div class="dm-dialog dm-detail-dialog">'+
        ...
        '<div class="dm-detail-body">'+
          ...
          '<div class="dm-photo-grid">'+
            (x.checkout_condition_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.checkout_condition_photo)+'" data-photo-label="Kondisi awal"><span>Kondisi awal</span><img src="'+E(x.checkout_condition_photo)+'" alt="Kondisi awal"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.checkout_condition_photo)+'" data-photo-label="Kondisi awal">Lihat Foto</button><button type="button" data-photo-download="'+E(x.checkout_condition_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-kondisi-awal.jpg')+'">Download</button></div></div>':'')+
            (x.checkout_odometer_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.checkout_odometer_photo)+'" data-photo-label="Spidometer awal"><span>Spidometer awal</span><img src="'+E(x.checkout_odometer_photo)+'" alt="Spidometer awal"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.checkout_odometer_photo)+'" data-photo-label="Spidometer awal">Lihat Foto</button><button type="button" data-photo-download="'+E(x.checkout_odometer_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-spidometer-awal.jpg')+'">Download</button></div></div>':'')+
            (x.return_condition_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.return_condition_photo)+'" data-photo-label="Kondisi akhir"><span>Kondisi akhir</span><img src="'+E(x.return_condition_photo)+'" alt="Kondisi akhir"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.return_condition_photo)+'" data-photo-label="Kondisi akhir">Lihat Foto</button><button type="button" data-photo-download="'+E(x.return_condition_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-kondisi-akhir.jpg')+'">Download</button></div></div>':'')+
            (x.return_odometer_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.return_odometer_photo)+'" data-photo-label="Spidometer akhir"><span>Spidometer akhir</span><img src="'+E(x.return_odometer_photo)+'" alt="Spidometer akhir"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.return_odometer_photo)+'" data-photo-label="Spidometer akhir">Lihat Foto</button><button type="button" data-photo-download="'+E(x.return_odometer_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-spidometer-akhir.jpg')+'">Download</button></div></div>':'')+
          '</div>'+
        '</div></div></div>';
    }
    if(modal.type==='fuel-detail'){
      ...
      return '<div class="dm-modal"><div class="dm-dialog dm-detail-dialog">'+
        ...
        '<div class="dm-detail-body">'+
          ...
          '<div class="dm-photo-grid">'+
            (x.receipt_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.receipt_photo)+'" data-photo-label="Foto struk BBM"><span>Foto struk BBM</span><img src="'+E(x.receipt_photo)+'" alt="Struk BBM"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.receipt_photo)+'" data-photo-label="Foto struk BBM">Lihat Foto</button><button type="button" data-photo-download="'+E(x.receipt_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-struk-bbm.jpg')+'">Download</button></div></div>':'')+
            (x.odometer_photo?'<div class="dm-photo-item"><button class="dm-photo-open" type="button" data-photo-view="'+E(x.odometer_photo)+'" data-photo-label="Foto spidometer"><span>Foto spidometer</span><img src="'+E(x.odometer_photo)+'" alt="Spidometer"></button><div class="dm-photo-controls"><button type="button" data-photo-view="'+E(x.odometer_photo)+'" data-photo-label="Foto spidometer">Lihat Foto</button><button type="button" data-photo-download="'+E(x.odometer_photo)+'" data-photo-name="'+E((x.plate||'kendaraan')+'-spidometer-bbm.jpg')+'">Download</button></div></div>':'')+
          '</div>'+
        '</div></div></div>';
    }
  ...
  function openPhotoViewer(url,label){
    document.querySelector('.dm-lightbox')?.remove();
    const box=document.createElement('div');
    box.className='dm-lightbox';
    box.innerHTML='<div class="dm-lightbox-head"><b>'+E(label||'Foto')+'</b><button type="button" data-lightbox-close>×</button></div><div class="dm-lightbox-body"><img src="'+E(url)+'" alt="'+E(label||'Foto')+'"></div><div class="dm-lightbox-actions"><button type="button" data-lightbox-download>Download Foto</button></div>';
    document.body.appendChild(box);
    box.addEventListener('click',async e=>{
      if(e.target===box||e.target.closest('[data-lightbox-close]')){box.remove();return}
      if(e.target.closest('[data-lightbox-download]'))await downloadPhoto(url,(label||'foto')+'.jpg');
    });
  }
  async function downloadPhoto(url,name='foto.jpg'){
    try{
      ...
      a.href=objectUrl;
      a.download=String(name||'foto.jpg').replace(/[^a-zA-Z0-9._-]+/g,'-');
  ...
  document.addEventListener('click',async e=>{
    ...
    if(!active)return;
    const photoView=e.target.closest('[data-photo-view]');
    if(photoView){e.preventDefault();openPhotoViewer(photoView.dataset.photoView,photoView.dataset.photoLabel||'Foto');return}
    const photoDownload=e.target.closest('[data-photo-download]');
    if(photoDownload){e.preventDefault();await downloadPhoto(photoDownload.dataset.photoDownload,photoDownload.dataset.photoName||'foto.jpg');return}
