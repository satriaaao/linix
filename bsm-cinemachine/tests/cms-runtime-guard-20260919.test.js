...
const cmsUi = require('../api/cms-ui.js');
...
assert.ok(String(cmsUi._source||'').includes('41f889cf6e2372123f9873abb2c4b47508292454'), 'CMS UI endpoint must proxy the known-good advanced UI commit');
