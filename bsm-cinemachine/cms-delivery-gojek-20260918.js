...
(function(){
  ...
  function injectCss(){
    ...
    .gd-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}    .gd-job-table-shell{display:block!important;overflow:visible}.gd-job-table-scroll{width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;border:1px solid #e2e7ef;border-radius:16px;background:#fff;box-shadow:0 7px 24px rgba(25,39,58,.045)}.gd-job-table{width:100%;min-width:1180px;border-collapse:collapse;table-layout:fixed}.gd-job-table th{position:sticky;top:0;z-index:2;padding:11px 10px;background:#f5f7fa;color:#778497;font-size:9px;text-align:left;font-weight:950;letter-spacing:.05em;border-bottom:1px solid #e2e7ef;white-space:nowrap}.gd-job-table td{padding:11px 10px;border-bottom:1px solid #edf0f4;vertical-align:top;color:#33445b;font-size:9px;line-height:1.38;background:#fff}.gd-job-table tbody tr:last-child td{border-bottom:0}.gd-job-table tbody tr:hover td{background:#fbfcfe}.gd-job-table td>b,.gd-job-table td>small,.gd-job-table td>em{display:block}.gd-job-table td>b{font-size:10px;color:#26364d}.gd-job-table td>small{margin-top:3px;color:#8692a3;font-size:8px}.gd-job-table td>em{margin-top:5px;color:#66758b;font-size:8px;font-style:normal;line-height:1.45}.gd-col-order{width:160px}.gd-col-customer{width:145px}.gd-col-schedule{width:150px}.gd-col-location{width:285px}.gd-col-driver{width:145px}.gd-col-status{width:150px}.gd-col-actions{width:220px}.gd-col-order .gd-kind{margin-bottom:7px}.gd-col-order>b{font-size:11px!important;letter-spacing:.01em}.gd-table-driver{display:block;padding:8px 9px;border-radius:10px}.gd-table-driver b,.gd-table-driver small{display:block}.gd-table-driver b{font-size:9px}.gd-table-driver small{margin-top:2px;font-size:7.5px}.gd-table-driver.assigned{background:#eaf8f2;color:#197b5d}.gd-table-driver.waiting{background:#f3f5f8;color:#69778a}.gd-table-live{display:block;margin-top:7px;padding:7px 8px;border-radius:9px;background:#eaf8f2;color:#24775e}.gd-table-live.off{background:#f3f5f8;color:#7a8797}.gd-table-live i{display:inline-block;width:7px;height:7px;margin-right:5px;border-radius:50%;background:currentColor}.gd-table-live b{font-size:8px}.gd-table-live small{display:block;margin:2px 0 0 12px;font-size:7px;color:inherit;opacity:.8}.gd-table-map{display:inline-block;margin-top:6px;color:#2673da;text-decoration:none;font-size:8px;font-weight:850}.gd-table-edit{margin-top:7px!important;min-height:28px!important;padding:0 8px!important;border-radius:8px!important;font-size:8px!important}.gd-table-actions{display:flex;flex-wrap:wrap;gap:5px}.gd-table-actions button,.gd-table-actions a{min-height:30px!important;height:auto!important;padding:6px 8px!important;border-radius:8px!important;font-size:7.5px!important;line-height:1.15!important;white-space:nowrap}.gd-table-code{display:block;margin-top:6px;color:#7f8b9b;font-size:7px}.gd-job-table .gd-status{padding:6px 7px;font-size:7.5px}.gd-job-table .gd-status i{width:6px;height:6px}@media(max-width:760px){.gd-toolbar{align-items:stretch;flex-direction:column}.gd-toolbar input{min-width:0;width:100%}.gd-job-table-scroll{border-radius:13px}.gd-job-table{min-width:1050px}.gd-job-table th{padding:9px 8px;font-size:8px}.gd-job-table td{padding:9px 8px}.gd-col-order{width:145px}.gd-col-customer{width:130px}.gd-col-schedule{width:135px}.gd-col-location{width:250px}.gd-col-driver{width:130px}.gd-col-status{width:135px}.gd-col-actions{width:190px}}
