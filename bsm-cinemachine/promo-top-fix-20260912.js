...
(function(){
  function installStyle(){
    ...
    st.textContent=`
      ...
      body #app .promo-slider{margin:0 0 20px!important;border-radius:0 0 22px 22px!important;box-shadow:0 18px 50px rgba(0,0,0,.14)!important;width:100%!important;background:#090909!important}
