/* Rentcam CMS stable admin login adapter */
(function(){
  ...
  /* Do not auto-delete CMS auth when iOS/browser discards sessionStorage.
     Explicit logout still clears both auth and the temporary admin secret. */
